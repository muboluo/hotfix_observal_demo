package com.demo.hotfix.ali.data.hotfix_demo.msg;


import com.demo.hotfix.ali.data.hotfix_demo.Util;
...
public class MsgObservable {
	...
	public void fire(Object sender, String msg, Object... args) {
		ArrayList<MsgListener> tofire = new ArrayList<MsgListener>(globalListeners.size() + 8);
		synchronized (this) {
